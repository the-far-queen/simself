...
try:
    ...
    # This legacy module references removed APIs (SpiralStage, SwedenborgianAxes, environment).
    # Per Grok master plan: not on the runtime path. The exception is captured so
    # importing the module still succeeds; classes defined here will raise at instantiation.
    _legacy_marker = repr(_e)
