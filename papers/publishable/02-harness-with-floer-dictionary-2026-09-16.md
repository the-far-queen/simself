# Harness with Floer Dictionary (Part IV — promoted 2026-09-17)

> **Promoted 2026-09-17** (per Grok master plan Step 7). Synthesized Part IV
> from the Grok review. Complements (does not replace) 13-mte-llm-wrapper-safety
> (the wrapper contract) and 02-adversarial-protocols (the 21 test spans).

Part IV of the FieldCore + SimSelf architecture overview. Heegaard Floer is
named as the algebra of the identity diagram; the harness loop's ten parts
are stated as predicates (veto, negotiation, packets, language intake, model
outside, persistence, attacks, traces, kernel, exam).
