# Proposal 04 — Operator Algebra Algebraic Closure

**Original Number:** 04 (Set 2)
...
**Claim**: The four substrate operators (coding, robotics, language, integration) close under composition — they form a monoid.

**Experiment** (summary):
- Verify operator composition laws
- Build closure proof
- Test via composition benchmarks

**Funding required** (summary):
- See breakdown below.
- **Total:** $155,000

**Academic fields**: operator algebra, AI substrate.
...
1. Verify operator composition laws.
2. Build closure proof.
3. Test via composition benchmarks.

## Funding breakdown

- **Mathematician (1 year):** $150,000
- **Compute:** $5,000
