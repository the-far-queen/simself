# Proposal 05 — FieldCore Geometric Compute Engine

**Original Number:** 05 (Set 2)
...
**Claim**: A standalone compute engine runs the substrate geometry natively (no Python overhead).

**Experiment** (summary):
- Implement substrate in Rust
- Benchmark vs Python reference
- Deploy as FieldCore Compute Engine

**Funding required** (summary):
- See breakdown below.
- **Total:** $370,000

**Academic fields**: high-performance computing, substrate engineering.
...
1. Implement substrate in Rust.
2. Benchmark vs Python reference.
3. Deploy as FieldCore Compute Engine.

## Funding breakdown

- **Senior engineer (2 years):** $350,000
- **Compute:** $20,000
