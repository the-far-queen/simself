# Proposal 03 — Sacred Library Swedenborg 50+ Axis Mapping

**Original Number:** 03 (Set 2)
...
**Claim**: Swedenborgian correspondences map to 50+ substrate axes (extending canonical 20-axis core).

**Experiment** (summary):
- Map Swedenborg's correspondences to substrate axes
- Build axis-mapping table
- Validate by running substrate against Swedenborg-derived test set

**Funding required** (summary):
- See breakdown below.
- **Total:** $260,000

**Academic fields**: computational theology, symbolic grounding.
...
1. Map Swedenborg's correspondences to substrate axes.
2. Build axis-mapping table.
3. Validate by running substrate against Swedenborg-derived test set.

## Funding breakdown

- **Theologian + engineer (2 years):** $250,000
- **Compute:** $10,000
