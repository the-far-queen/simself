# Proposal 09 — MTE Machine Translation Engine Bidirectional Loss

**Original Number:** 09 (Set 2)
...
**Claim**: MTE achieves < bidirectional loss on language <-> substrate translation.

**Experiment** (summary):
- Build MTE bidirectional
- Measure loss on held-out test set
- Compare to unidirectional baseline

**Funding required** (summary):
- See breakdown below.
- **Total:** $300,000

**Academic fields**: machine translation, semantic grounding.
...
1. Build MTE bidirectional.
2. Measure loss on held-out test set.
3. Compare to unidirectional baseline.

## Funding breakdown

- **Engineer (2 years):** $280,000
- **Compute:** $20,000
