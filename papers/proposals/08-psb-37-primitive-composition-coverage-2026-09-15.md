# Proposal 08 — PSB 37-Primitive Composition Coverage

**Original Number:** 08 (Set 2)
...
**Claim**: 37 PSB primitives + composition rules cover 95%+ of common English utterances.

**Experiment** (summary):
- Define 37 PSBs
- Define composition rules
- Test on 10000 utterances

**Funding required** (summary):
- See breakdown below.
- **Total:** $310,000

**Academic fields**: computational linguistics, semantic composition.
...
3. Test on 10000 utterances.

## Funding breakdown

- **Linguist + engineer (2 years):** $300,000
- **Compute:** $10,000
